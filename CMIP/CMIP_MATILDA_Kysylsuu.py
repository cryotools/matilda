...
obs_data = home + "/Seafile/Ana-Lena_Phillip/data/input_output/input/observations/karabatkak/obs_kyzylsuu_runoff_1994_1997_zero.csv"
...
output_path = "/home/ana/Desktop/Meeting/"
...
#parameter_df = pd.read_csv(home + "/Seafile/Ana-Lena_Phillip/data/scripts/Test_area/Karabatkak_Catchment/best_param_kysyl_20210511.csv")
## Obs data
obs = pd.read_csv(home + "/Seafile/Azamat_AvH/workflow/data/Runoff/obs_kyzylsuu_runoff_Hydromet.csv")
...
obs["Qobs"] = np.where(obs["year"] == 2016, np.nan, obs["Qobs"])

obs = obs.drop(columns=['month', 'year'])
#obs.to_csv(home + "/Seafile/Azamat_AvH/workflow/data/Runoff/obs_kyzylsuu_runoff_Hydromet_Null.csv")


##
obs = pd.read_csv(home + "/Seafile/Azamat_AvH/workflow/data/Runoff/obs_kyzylsuu_runoff_Hydromet_Null.csv")
...
df_preproc, obs_preproc = MATILDA_preproc(df, parameter, obs=obs)
...
#plt.show()
plt.savefig("/home/ana/Desktop/Meeting/CMIP6_Kyzylsuu_mean_annual.png", dpi=700, bbox_inches='tight')
