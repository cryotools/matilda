...
x, y = 78.06284861, 42.32793047 # hydro (klappt nicht)
y2, x2 = 42.32703430, 78.06141496 # hydro klappt (selbst gewählt)
...
grid.catchment(data=grid.dir, x=x2, y=y2, dirmap=dirmap, out_name='catch',
...
with fiona.open(output_file + "shapefile_hydro_kyzylsuu.shp", 'w',
