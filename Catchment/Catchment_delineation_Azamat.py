...
##
# DEM_file = home + '/Seafile/Ana-Lena_Phillip/data/input_output/input/observations/karabatkak/static/ALPSMLC30_N042E078_DSM_glacier_clip.tif'
DEM_file = home + '/Seafile/Ana-Lena_Phillip/data/input_output/input/observations/karabatkak/static/srtm_glacier_clip.tif'
...
col, row = grid.nearest_cell(x3, y3)
grid.catchment(data=grid.dir, x=col, y=row, dirmap=dirmap, out_name='catch',
...
with fiona.open(output_file + "shapefile_hydro_glacier_catchments.shp", 'w',
                driver='ESRI Shapefile',
                crs=grid.crs.srs,
                schema=schema) as c:
    i = 0
