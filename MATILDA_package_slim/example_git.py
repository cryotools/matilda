...
parameter = MATILDA.MATILDA_parameter(df, set_up_start='2010-01-01 00:00:00', set_up_end='2010-12-31 23:00:00',
                       			sim_start='2011-01-01 00:00:00', sim_end='2020-11-01 23:00:00', freq="D", 						lat=40, area_cat=5.5, area_glac=2.2, ele_dat=3500, ele_glac=4000, 						ele_cat=3650, CFMAX_ice=5.5, CFMAX_snow=3)
# Data preprocessing
...
output_MATILDA = MATILDA.MATILDA_simulation(df, obs=obs, output=output, set_up_start='2010-01-01 12:00:00', 							set_up_end='2010-12-31 12:00:00', sim_start='2011-01-01 12:00:00',
						sim_end='2020-12-31 12:00:00', freq="D", lat=40, area_cat=5.5, 							area_glac=2.2, ele_dat=3500, ele_glac=4000, ele_cat=3650, 
