...
plup <- read.table("C:\\Users\\flore\\Seafile\\Ana-Lena_Phillip\\data\\HBV-Light\\HBV-light_data\\Glacier_No.1\\Python\\Glacier_Run\\Results\\Multi.txt", sep="\t", dec = ".", header=TRUE)
