...
# karab_par = mspot.psample(df=df, obs=obs, rep=3, dbformat='csv', dbname='karabatkak_upper_para_samplig', set_up_start='2017-01-01 00:00:00', set_up_end='2018-12-31 23:00:00',
