...
shape_file = working_directory + "/kb_outline_rgi_4326.shp"
era5_land_static_file = "/home/ana/Seafile/Ana-Lena_Phillip/data/input_output/input/ERA5/global/ERA5_global_z.nc"

era5_land_file = working_directory + "/20200717_Issyk_Kul_ERA5L_1982_1989.nc"
#era5_land_file = working_directory + '/era5/20200717_Issyk_Kul_ERA5L_1982_1989.nc'
aws_file = working_directory + "/obs.karabatkak.1982-1990.csv"
output_csv = working_directory + '/input/20200728_Katabak_ERA5_land_1982_1989.csv'

start_date = '1982-01-01 00:00:00'
end_date = '1989-12-31 23:00:00'
...
aws["time"] = pd.to_datetime(aws[['Year', 'Month', 'Day']])
aws.set_index('time', inplace=True)
aws = aws[start_date: end_date]
...
# load obs and ERA5 into R to apply quantile mapping
era5_temperature = era5_land['t2m']
era5_temperature = era5_temperature.resample(time="D").mean()
aws["temp_era"] = era5_temperature
