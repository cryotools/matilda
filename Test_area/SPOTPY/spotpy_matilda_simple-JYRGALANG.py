...
rep = 3
dbname='20211210_mpi_mc_jyrgalang',
dbformat='csv'
...
input_path_data = home + "/EBA-CA/Azamat_AvH/workflow/data/Jyrgalang/obs/"
input_path_observations = home + "/EBA-CA/Azamat_AvH/workflow/data/Jyrgalang/obs/"


data_csv = "edit_t2m_jyrgalang_ERA5L_1982_2020.csv" # dataframe with columns T2 (Temp in Celsius), RRR (Prec in mm) and if possible PE (in mm)
observation_data = "runoff_jyrgalang_2000_2021.csv" # Daily Runoff Observations in mm
...
set_up_end='2003-12-31 23:00:00'
sim_start='2000-01-01 00:00:00'
sim_end='2020-11-20 23:00:00'
freq="D"
lat=40
area_cat=254
area_glac=1.71
...
sampler = spotpy.algorithms.mc(spot_setup, dbname=dbname, dbformat=dbformat)#, parallel='mpi')
sampler.sample(rep)
...
# console: mpirun -c 2 python3 /home/phillip/Seafile/Ana-Lena_Phillip/data/matilda/Test_area/SPOTPY/spotpy_matilda_simple-JYRGALANG.py
